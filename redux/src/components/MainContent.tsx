...
class MainContent extends React.Component<{ activeTask:Task,activeList: List , makeTaskActive:(e:any)=> void,selectTask:(e:any)=>void,makeTaskImportant:(e:any)=>void}, { newList: boolean, taskValue: string }> {
      ...
      <div className="page-content box-shadow-right">
        ...
        <div className="task-list">
          <div className="new-tasks" id={this.props.activeList.getId()}>
            <ListTasks list={this.props.activeList} makeTaskActive={this.props.makeTaskActive} selectTask={this.props.selectTask} makeTaskImportant={this.props.makeTaskImportant}/>
          </div>
